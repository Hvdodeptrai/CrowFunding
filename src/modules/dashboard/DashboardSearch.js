...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative">
      <div className="bg-white rounded-full shadow-[10px_10px_20px_rgba(218,_218,_218,_0.75)] w-full flex items-center p-2 relative z-50">
        ...
        <button className="w-[72px] h-10 rounded-full bg-primary text-white flex justify-center items-center flex-shrink-0">
          <svg
